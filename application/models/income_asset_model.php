...
class Income_asset_model extends CI_Model {
    ...
    public function createIncomeAsset() {
        $data = array(
    ...
    public function get_income_asset($id) {
        $query = $this->db->get_where($this->tn, array('id' => $id));
        return $query->row();
    }

    public function get_income_assets() {
        $this->db->order_by("description", "asc");
        $query = $this->db->get_where($this->tn, array('enabled' => 1));
        return $query->result_array();
    }

    public function get_user_income_assets($userId) {
        $this->db->order_by("description", "asc");
    ...
    public function get_only_user_income_assets($userId) {
        $this->db->order_by("description", "asc");
