    ...
    <div class="large-12 columns" >
        ...
        <?php if (!empty($search)) {
            ...
            <h3 id="SearchCriteria">
                Search Text: <?php echo $search[0]["text"]; ?> 
                From Date: <?php echo strtotime($search[0]["start_date"]) . " | " . (strtotime($search[0]["start_date"]) == 0) ? "None" : $search[0]["start_date"]; ?> 
                To Date: <?php echo strtotime($search[0]["end_date"]) . " | " . (strtotime($search[0]["end_date"]) == 0) ? "None" : $search[0]["end_date"]; ?> 
