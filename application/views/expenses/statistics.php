...
<h2>Statistics for the period 
    from&nbsp;<input type="text" name="fromDate" id="fromDate" value="<?php echo $startAndEndDateforMonth[0]; ?>"/>&nbsp;
    To&nbsp;<input type="text" name="toDate" id="toDate" value="<?php echo $startAndEndDateforMonth[1]; ?>"/> ( <?php echo floor((strtotime($startAndEndDateforMonth[1]) - strtotime($startAndEndDateforMonth[0])) /(60*60*24))+1 ;?> days ) &nbsp;<input type="submit" name="filter" value="Filter" id="filter" />
</h2>
<br/>
</form>
    ...
    <table>
        ...
        <tbody>
            ...
            foreach ($topFiveExpenses as $k => $v) {
                ...
                echo "<td class='align-right'>" . number_format($v["amount"], 2, ".", ",") . "</td>";
                echo "<td class='align-right'>" . $v["expense_date"] . "</td>";
    ...
    <table>
        ...
        <tbody>
            ...
            foreach ($topFiveExpenseTypes as $k => $v) {
                ...
                echo "<td class='align-right'>" . number_format($v["value"], 2, ".", ",") . "</td>";
                echo "<td class='align-right'>" . $v["expenseCount"] . "</td>";
