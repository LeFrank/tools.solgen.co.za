...
<div class="row expanded">
    <div class="large-12 columns">
                        ...
                        <?php foreach ($paymentMethods as $k => $v) { ?>
                            <tr>    
                                ...
                                <td>
                                    ...
                                    <a href="/payment-methods/delete/<?php echo $v["id"]; ?>" onclick="return confirm_delete()">delete</a></td>
                            </tr>
                            <?php
                        }
                        ?>
        ...
        <div id="manage-payment-type-form">
            ...
            <input type="submit" name="submit" value="Create Payment Method" class="button"/>
            </form>
        </div>
    </div></div>